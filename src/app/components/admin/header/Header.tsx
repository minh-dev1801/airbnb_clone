    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white px-10 py-6 flex items-center justify-between">
      <Link href="/admin">
        <div className="flex items-center space-x-2">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/airbnb-1.svg" alt="Airbnb Logo" className="h-9 w-9" />
          <span className="text-3xl font-bold text-[#fe6b6e]">airbnb</span>
        </div>
      </Link>
      ...
      <div className="flex items-center space-x-2">
        <Dropdown menu={menu} trigger={['hover']}>
          <div className="relative">
            ...
            <div className="w-11 h-11 rounded-full bg-gray-500 text-white  items-center justify-center text-lg font-semibold cursor-pointer hidden">
